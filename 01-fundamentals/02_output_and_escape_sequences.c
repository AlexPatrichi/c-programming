...
PURPOSE: Illustrates sequential execution of statements with printf() and demonstrates the use 
of escape sequences in C, including: \n (newline), \t (tab), \\ (backslash), and \" (double quote). 
===================================================================================================
*/
...
int main(void) {  
/* A computer program is a list of statements (instructions) that a computer executes sequentially, 
from top to bottom.
...
Each printf() is a statement that outputs text to the console, and the return statement indicates
that the program has finished executing successfully. */